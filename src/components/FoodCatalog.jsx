...
const FoodCatalog = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-start mt-5 sm:mt-7 md:mt-10">
            ...
            <div className="w-full px-5 my-5 flex justify-center items-center overflow-x-auto">
                {categoryNames.map((category, index) => (
                    <button key={index}
                        onClick={() => setSelectedCategory(category)}
                        className={`bg-[#F2F2EC] px-4 py-2 mx-2 sm:mx-3 md:mx-4 text-base sm:text-lg md:text-xl font-semibold rounded-full cursor-pointer
